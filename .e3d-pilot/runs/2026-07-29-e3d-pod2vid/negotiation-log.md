...
<!-- runner:verify=python -m pytest tests/ -->
...
Reason: Spec is complete, internally consistent, and all acceptance criteria are testable without ambiguity.
...
Reason: The draft is internally consistent, implementation-ready, testable, and provides clear behavior, failure handling, compatibility, and acceptance criteria.
...
Reason: The draft is clear and comprehensive, meeting all specified requirements.
